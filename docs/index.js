...
var author$project$Main$Model = F5(
	function (key, steps, points, repeats, active) {
		return {active: active, key: key, points: points, repeats: repeats, steps: steps};
	});
var author$project$Main$Steps = {$: 'Steps'};
var author$project$Main$UrlChange = function (a) {
	return {$: 'UrlChange', a: a};
};
var author$project$Main$UrlRequest = {$: 'UrlRequest'};
...
var author$project$Main$parametersFromUrl = function (url) {
	var _n0 = url.fragment;
	if (_n0.$ === 'Nothing') {
		return {
			points: 3,
			repeats: elm$core$Array$fromList(_List_Nil),
			steps: 1
		};
	} else {
		var fragment = _n0.a;
		var parts = elm$core$Array$fromList(
		...
		var steps = A2(
			...
			elm$core$String$toInt(
				A2(
					elm$core$Maybe$withDefault,
					'1',
					A2(elm$core$Array$get, 0, parts))));
		return {points: points, repeats: repeats, steps: steps};
	}
};
...
var author$project$Main$subscriptions = function (model) {
	return elm$browser$Browser$Events$onKeyDown(
		A2(
			...
			A2(elm$json$Json$Decode$map, author$project$Main$toKey, author$project$Main$keyDecoder)));
};
...
var author$project$Main$decrementWithLimit = function (value) {
	return (value > 1) ? (value - 1) : value;
};
var author$project$Main$incrementWithLimit = function (value) {
	return (value < 99) ? (value + 1) : value;
};
var author$project$Main$stringForParams = function (model) {
	return elm$core$String$fromInt(model.steps) + (',' + (elm$core$String$fromInt(model.points) + A3(
		elm$core$Array$foldl,
		F2(
			function (i, a) {
...
var author$project$Main$setURL = function (model) {
	return A2(
		...
		model.key,
		'#' + author$project$Main$stringForParams(model));
};
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'UrlChange':
				var url = msg.a;
				var params = author$project$Main$parametersFromUrl(url);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{points: params.points, repeats: params.repeats, steps: params.steps}),
					elm$core$Platform$Cmd$none);
			case 'UrlRequest':
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			case 'SetPoints':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							points: elm$core$Basics$floor(p)
						}),
					elm$core$Platform$Cmd$none);
			case 'SetRepeat':
				var position = msg.a;
			...
			default:
					...
					switch (key.$) {
						case 'Left':
							return _Utils_update(
								...
								{
									active: function () {
										var _n2 = model.active;
										switch (_n2.$) {
											case 'Steps':
												return author$project$Main$Steps;
											case 'Points':
												return author$project$Main$Steps;
											case 'Repeat':
												var pos = _n2.a;
												return (pos > 0) ? author$project$Main$Repeat(pos - 1) : author$project$Main$Points;
											default:
												return (!elm$core$Array$length(model.repeats)) ? author$project$Main$Points : author$project$Main$Repeat(
													elm$core$Array$length(model.repeats) - 1);
										}
									}()
								});
						case 'Right':
							return _Utils_update(
								...
								{
									active: function () {
										var _n3 = model.active;
										switch (_n3.$) {
											case 'Steps':
												return author$project$Main$Points;
											case 'Points':
												return (!elm$core$Array$length(model.repeats)) ? author$project$Main$New : author$project$Main$Repeat(0);
											case 'Repeat':
												var pos = _n3.a;
												return (_Utils_cmp(
													pos,
													elm$core$Array$length(model.repeats) - 1) > -1) ? author$project$Main$New : author$project$Main$Repeat(pos + 1);
											default:
												return author$project$Main$New;
										}
									}()
								});
						case 'Up':
							var _n4 = model.active;
							switch (_n4.$) {
								case 'Steps':
									return _Utils_update(
										model,
										{
											steps: author$project$Main$incrementWithLimit(model.steps)
										});
								case 'Points':
									return _Utils_update(
										model,
										{
											points: author$project$Main$incrementWithLimit(model.points)
										});
								case 'Repeat':
									var index = _n4.a;
									var current = A2(
										elm$core$Maybe$withDefault,
										0,
										A2(elm$core$Array$get, index, model.repeats));
									var add = author$project$Main$incrementWithLimit(current);
									var _new = A3(elm$core$Array$set, index, add, model.repeats);
									return _Utils_update(
										model,
										{repeats: _new});
								default:
									return _Utils_update(
										model,
										{
											active: author$project$Main$Repeat(
												elm$core$Array$length(model.repeats)),
											repeats: A2(elm$core$Array$push, 1, model.repeats)
										});
							}
						case 'Down':
							var _n5 = model.active;
							switch (_n5.$) {
								case 'Steps':
									return _Utils_update(
										model,
										{
											steps: author$project$Main$decrementWithLimit(model.steps)
										});
								case 'Points':
									return _Utils_update(
										model,
										{
											points: author$project$Main$decrementWithLimit(model.points)
										});
								case 'Repeat':
									var index = _n5.a;
									var lastIndex = elm$core$Array$length(model.repeats) - 1;
									var current = A2(
										elm$core$Maybe$withDefault,
										0,
										A2(elm$core$Array$get, index, model.repeats));
									var _n6 = ((current < 2) && _Utils_eq(index, lastIndex)) ? _Utils_Tuple2(
										A3(elm$core$Array$slice, 0, lastIndex, model.repeats),
										((lastIndex - 1) >= 0) ? author$project$Main$Repeat(lastIndex - 1) : author$project$Main$Points) : _Utils_Tuple2(
										A3(
											elm$core$Array$set,
											index,
											author$project$Main$decrementWithLimit(current),
											model.repeats),
										author$project$Main$Repeat(index));
									var newRepeat = _n6.a;
									var newPosition = _n6.b;
									return _Utils_update(
										model,
										{active: newPosition, repeats: newRepeat});
								default:
									return model;
							}
						default:
				...
				return _Utils_Tuple2(
					newModel,
					author$project$Main$setURL(newModel));
		}
	});
var elm$core$Basics$modBy = _Basics_modBy;
var author$project$Fractal$wrappingGet = F2(
...
var author$project$Fractal$drawPoints = F2(
	function (step, points) {
		var arrayOfPoints = elm$core$Array$fromList(points);
		return A2(
			...
			F2(
				function (i, _n0) {
					var x1_ = _n0.a;
					var y1_ = _n0.b;
					var _n1 = A2(author$project$Fractal$wrappingGet, i + step, arrayOfPoints);
					var x2_ = _n1.a;
					var y2_ = _n1.b;
					return A2(
						elm$svg$Svg$line,
...
var author$project$Fractal$groupItems = F3(
	function (count, scale, items) {
		return A2(
			elm$core$List$map,
			function (_n0) {
				var i = _n0.a;
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							'scale(0.5 0.5) ' + ('translate(0 -100) ' + ('rotate(' + (elm$core$String$fromFloat(r) + ' 0 100)'))))
						]),
					items);
			},
			A2(
				elm$core$List$map,
				function (i) {
					return _Utils_Tuple2(i, (360 / count) * i);
				},
...
var author$project$Fractal$draw = F3(
	function (step, points, repeats) {
		var segments = (2 * elm$core$Basics$pi) / points;
		var scale = 100;
		var lines = A2(
			author$project$Fractal$drawPoints,
			step,
			A2(
				elm$core$List$map,
				function (_n0) {
					var x = _n0.a;
					var y = _n0.b;
					return _Utils_Tuple2(x * scale, (y * scale) * (-1));
				},
				elm$core$List$reverse(
					A2(
						...
						function (m) {
							return _Utils_Tuple2(
								elm$core$Basics$cos((segments * ((-1) * m)) + (elm$core$Basics$pi / 2)),
								elm$core$Basics$sin((segments * ((-1) * m)) + (elm$core$Basics$pi / 2)));
						},
						A2(
							elm$core$List$map,
							elm$core$Basics$toFloat,
							A2(elm$core$List$range, 0, points - 1))))));
		var items = A3(
			elm$core$List$foldl,
			F2(
				function (c, svg) {
					return A3(author$project$Fractal$groupItems, c, scale, svg);
				}),
			lines,
			repeats);
		return A2(
			...
			_List_fromArray(
				[
					...
					elm$svg$Svg$Attributes$viewBox('-105 -105 210 210')
				]),
			A2(
				elm$core$List$cons,
				A2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					active ? 'active-control' : 'passive-control')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('control-text')
						]),
					_List_fromArray(
						[
							function () {
							if (value.$ === 'Just') {
								var hasValue = value.a;
								return elm$html$Html$text(
									elm$core$String$fromInt(hasValue));
							} else {
								return elm$html$Html$text('');
							}
						}()
...
var author$project$Main$valueIsRepeat = F2(
	function (expected, current) {
		if (expected.$ === 'Repeat') {
			var index = expected.a;
			return _Utils_eq(index, current);
		} else {
			return false;
		}
	});
var author$project$Main$inputControls = function (model) {
	return _Utils_ap(
		_List_fromArray(
			[
				A2(
				author$project$Main$control,
				_Utils_eq(model.active, author$project$Main$Steps),
				elm$core$Maybe$Just(model.steps)),
				A2(
				author$project$Main$control,
				_Utils_eq(model.active, author$project$Main$Points),
			...
			A2(
				...
				F2(
					function (index, value) {
						return A2(
							author$project$Main$control,
							A2(author$project$Main$valueIsRepeat, model.active, index),
							elm$core$Maybe$Just(value));
					}),
				elm$core$Array$toList(model.repeats)),
			_List_fromArray(
				[
					A2(
					author$project$Main$control,
					_Utils_eq(model.active, author$project$Main$New),
					elm$core$Maybe$Nothing)
				])));
};
var author$project$Main$view = function (model) {
	return {
					...
					[
						...
						_List_fromArray(
							[
								...
								author$project$Main$inputControls(model))
							])),
						A2(
						elm$html$Html$div,
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('fractal-container')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('fractal')
									]),
								_List_fromArray(
									[
										A3(
										author$project$Fractal$draw,
										model.steps,
										model.points,
										elm$core$Array$toList(model.repeats))
									]))
		...
		title: author$project$Main$stringForParams(model)
	};
};
...
var author$project$Main$main = elm$browser$Browser$application(
	{
		init: F3(
			function (flags, url, key) {
				var params = author$project$Main$parametersFromUrl(url);
				return _Utils_Tuple2(
					A5(author$project$Main$Model, key, params.steps, params.points, params.repeats, author$project$Main$Steps),
					elm$core$Platform$Cmd$none);
			}),
		onUrlChange: function (url) {
			return author$project$Main$UrlChange(url);
		},
		onUrlRequest: function (url) {
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(
		{}))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"SetPoints":["Basics.Float"],"SetRepeat":["Basics.Int","Basics.Float"],"KeyEvent":["Main.Key"],"UrlChange":["Url.Url"],"UrlRequest":[]}},"Main.Key":{"args":[],"tags":{"Left":[],"Right":[],"Up":[],"Down":[],"Other":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}}}}})}});}(this));